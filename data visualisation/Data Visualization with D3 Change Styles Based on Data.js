...
// For example, you may want to color a data point blue if has a value less than 20, and red otherwise. 
...
// Add the style() method to the code in the editor to set the color of the h2 elements conditionally. 
