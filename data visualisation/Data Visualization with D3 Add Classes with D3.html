// Using a lot of inline styles on HTML elements gets hard to manage, even for smaller apps. 
// It's easier to add a class to elements and style that class one time using CSS rules. 
