// The last challenge created an svg element with a given width and height, 
//     which was visible because it had a background-color applied to it in the style tag. 
...
// Also, give the rect x and y attributes each set to 0.
