...
// For example, in a note-taking app with user authentication, one reducer could handle authentication while another handles the text and notes 
// that the user is submitting. For such an application, we might write the combineReducers() method like this:
...
//  ssign counterReducer to a key called count and authReducer to a key called auth.