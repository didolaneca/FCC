...
// It's common to dispatch an action before initiating any asynchronous behavior so that your application state knows that some data is 
// being requested (this state could display a loading icon, for instance). 
